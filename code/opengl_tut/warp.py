...
# https://github.com/davidpendergast/pygame-utils/blob/main/warp.py
# https://www.reddit.com/r/pygame/comments/k1pf37/render_pyopengl_onto_a_normal_pygame_surface/
# https://groups.google.com/g/pygame-mirror-on-google-groups/c/47n8sJMCEh0?pli=1
...
if __name__ == "__main__":
    ...
    frog_img = pygame.transform.scale(frog_img, (frog_img.get_width(),
                                                 frog_img.get_height()))
